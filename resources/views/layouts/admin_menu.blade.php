        ...
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.movies.add') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Movie</p>
                            </a>
                        </li>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.cates.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Cates</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.cates.add') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Cate</p>
                            </a>
                        </li>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.countries.add') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Country</p>
                            </a>
                        </li>
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('admin.dailymotion.index') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>List Dailymotion</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('admin.dailymotion.add') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Add Dailymotion</p>
                            </a>
                        </li>
