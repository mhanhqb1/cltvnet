...
<div class="row">
    ...
    @include('layouts.front_left_cates', ['cateType' => $movie->cate_type])
    </div>
    ...
    <div class="col-sm-8">
                ...
                <ul class="related-movies">
                    ...
                    <li>
                        <div class="movie-image">
                            <a href="{{ route('home.movie_detail2', $v->slug) }}" target="_blank" title="{{ $v->name }}">
                                <img src="{{ getImageUrl($v->image) }}" alt="{{ $v->name }}"/>
                            </a>
                        </div>
                        <div class="movie-info">
                            <h4><a href="{{ route('home.movie_detail2', $v->slug) }}" target="_blank">{{ $v->name }}</a></h4>
                            @if(!empty($v->cates))
                                <p>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p>
                        <b>
                            <font style="vertical-align: inherit;">
                                <font style="vertical-align: inherit;">Tên video:</font>
                            </font>
                        </b>
                        <font style="vertical-align: inherit;">
                            <font style="vertical-align: inherit;"> {{ $movie->name }}</font>
        ...
        <div class="inner-box category-content" style="padding-bottom: 5px;">
            <h2 class="title-2" style="color:#cd1d1f; font-weight:bold;"> <i class="fa fa-tags"></i>
                <font style="vertical-align: inherit;">
                    <font style="vertical-align: inherit;">Danh sách videos</font>
                </font>
            </h2>
            <div class="faq-content">
                    ...
                    <div class="panel" style="border:1px solid #AAAAAA;">
                        ...
                        <div aria-labelledby="headingOne" role="tabpanel" class="panel-collapse collapse in" id="collapseOne" aria-expanded="true">
                            ...
                            <div class="panel-body pprc">
                                <a data-id="{{ $video->id }}" href="{{ route('home.video_detail2', ['movieSlug' => $movie->slug, 'videoSlug' => $video->slug]) }}">
                                    <font style="vertical-align: inherit;">
