                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="select2" name="cates[]" multiple="multiple" data-placeholder="Chọn danh mục" style="width: 100%;">
                            ...
                            <option value="{{ $cate->id }}" {{ !empty($movieCates) && in_array($cate->id, $movieCates) ? 'selected="selected"' : '' }}>{{ $cate->vi_name }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <select class="select2 form-control" name="country_id" data-placeholder="Chọn quốc gia" style="width: 100%;">
                            ...
                            <option value="{{ $country->id }}" {{ $item->country_id == $country->id ? 'selected="selected"' : '' }}>{{ $country->vi_name }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
            ...
            <div class="card card-secondary">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="danfra_url" class="form-control" name="danfra_url" value="{{ old('danfra_url') ? old('danfra_url') : $item->danfra_url }}">
                    </div>
                    <div class="form-group">
                        ...
                        <select class="form-control" name="user_id" data-placeholder="" style="width: 100%;">
                            ...
                            <option value="{{ $user->id }}" {{ $item->user_id == $user->id ? 'selected="selected"' : '' }}>{{ $user->name }}</option>
                            @endforeach
                            @endif
                        </select>
                    </div>
