    ...
    <section class="tstbite-components my-4 my-md-5">
        <div class="d-sm-flex">
            ...
            <div>
                ...
                <h5 class="py-3 mb-0 h2">{{ $food->name }}</h5>
            </div>
        </div>
        ...
        <div class="blog-detail">
            ...
            <div class="rounded-12 overflow-hidden position-relative tstbite-svg">
                <img src="{{ $food->image }}" class="w-100" alt="food">
            ...
            <div class="row mt-0">
                <div class="col-md-6">
                    <div class="mt-4 mt-md-5">
                        ...
                        <div class="checklist pb-2">
                            @foreach($foodRecipes as $k => $foodRecipe)
                            <div class="form-check form-check-rounded recipe-checkbox">
                                <input type="checkbox" id="ingredient-{{ $foodRecipe->food_recipe_id }}" name="ingredient_{{ $foodRecipe->food_recipe_id }}" class="form-check-input">
                                <label class="form-check-label" for="ingredient-{{ $foodRecipe->food_recipe_id }}">{{ $foodRecipe->ingredient->name }}</label>
                            </div>
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="mt-4 mt-md-5">
                        ...
                        <div class="row pb-2">
                            @foreach ($foodVideos as $video)
                                <div class="col-lg-3 col-md-4 col-6">
                                    @include('front.foods.elements.food-video', ['video' => $video, 'food' => $food])
                                </div>
                            @endforeach
                        </div>
                    </div>
